<%-- 
    Document   : productos
    Created on : 15-11-2020, 20:43:57
    Author     : Jhonathan
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-4">
                    <form  action="Controlador?menu=productos" name="frmProductos" id="frmProductos" method="POST" 
                           class="needs-validation" novalidate >
                        <div class="mb-6">
                            <label for="txtNomPro">Nombre</label>
                            <div id="val" class="input-group is-invalid">
                                <input type="text" class="form-control is-invalid" 
                                       aria-describedby="validatedInputGroupPrepend" id="txtNomPro" name="txtNomPro"
                                       value="${productos.getNombre()}">
                            </div>
                            <label for="txtSKU">SKU</label>
                            <div id="val" class="input-group is-invalid">
                                <input type="text" class="form-control is-invalid" 
                                       aria-describedby="validatedInputGroupPrepend" id="txtSKU" name="txtSKU"
                                       value="${productos.getSku()}">
                            </div>
                        </div>
                        <div class="mb-6">
                            ...
                            <div class="input-group is-invalid">
                                <input type="date" class="form-control is-invalid" aria-describedby="validatedInputGroupPrepend" 
                                       id="txtFecha" name="txtFecha" value="${productosPrecios.getfecha()}">
                            </div>
                        </div>
                        <div class="mb-6">
                            <label for="txtPreNeto">Precio Neto</label>
                            <div class="input-group is-invalid">
                                <input type="text" class="form-control is-invalid" aria-describedby="validatedInputGroupPrepend" 
                                       id="txtPreNeto" name="txtPreNeto" value="${productosPrecios.getPrecioNeto()}">
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-dark">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <c:forEach items="${productosDao.listarPrecios()}" var="productos">
                                    <th>${productos.id}</th>
                                    <th>${productos.nombre}</th>
                                    <th>${productos.sku}</th>
                                    <th>${productos.fecha}</th>
                                    <th>${productos.neto}</th>
                                    <th>${productos.iva}</th>
                                    <th>${productos.bruto}</th>
